...
class Qwen3VisionEmbedder:
    ...
    def batch_analyze(
        ...
        for i in range(0, len(images), self.batch_size):
            ...
            for img, prompt, ctx in zip(batch_images, batch_prompts, batch_contexts):
...
_vision_model: Optional[Qwen3VisionEmbedder] = None
_text_llm: Optional[Union[Qwen3TextLLM, Qwen3VLTextLLM]] = None
_embedding_model: Optional[Any] = None
_unified_model: Optional[UnifiedQwen3VL] = None
...
def get_vision_model(
    ...
    device: str = "cuda",
    torch_dtype: str = "float16"
) -> Union[Qwen3VisionEmbedder, UnifiedQwen3VL]:
...
def get_text_llm(
    ...
    device: str = "cuda",
    torch_dtype: str = "float16"
) -> Union[Qwen3TextLLM, Qwen3VLTextLLM, UnifiedQwen3VL]:
...
def get_embedding_model(
    ...
    device: str = "cuda",
    torch_dtype: str = "float16"
) -> Union[Qwen3Embedding, Qwen3VLEmbedding]:
...
class Phi35TextLLM:
    ...
    def __init__(
        ...
        logger.info(f"Loading Phi-3.5 model {model_name} on {self.device} (8-bit: {self.load_in_8bit})...")
