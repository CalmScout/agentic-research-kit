    ...
    def parameters(self) -> dict[str, Any]:
        return {
            ...
            "properties": {
                ...
                "extract_mode": {"type": "string", "enum": ["markdown", "text"], "default": "markdown", "description": "Output format"},
                "max_chars": {"type": "integer", "minimum": 100, "description": "Truncate content if longer than this"}
            },
            "required": ["url"]
        }
    
    async def execute(self, url: str, extract_mode: str = "markdown", max_chars: Optional[int] = None, **kwargs: Any) -> str:
